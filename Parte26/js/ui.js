...
let colorPicker1El, fillTypeEl, colorPicker2El, color2ContainerEl;
...
export function initUI(elements) {
    ...
    fillTypeEl = elements.fillType;
    colorPicker1El = elements.colorPicker1;
    colorPicker2El = elements.colorPicker2;
    color2ContainerEl = elements.color2Container;
    // --- FIM DA ATUALIZAÇÃO ---
...
export function updateContextualPanels() {
    ...
    if (selectedObject.type === 'text' || selectedObject.type === 'rectangle') {
        // --- LÓGICA ATUALIZADA ---
        fillTypeEl.value = selectedObject.fill.type;
        colorPicker1El.value = selectedObject.fill.color1;

        // Por enquanto, a Cor 2 fica sempre escondida.
        color2ContainerEl.style.display = 'none';
    }
    ...
    if (selectedObject.fill) {
        ...
        // --- LÓGICA NOVA PARA O GRADIENTE ---
        if (selectedObject.fill.type === 'linear') {
            color2ContainerEl.style.display = 'flex'; // Mostra o seletor da Cor 2
            if (selectedObject.fill.color2) {
                colorPicker2El.value = selectedObject.fill.color2;
            }
        } else {
            color2ContainerEl.style.display = 'none'; // Esconde o seletor da Cor 2
        }
    }
